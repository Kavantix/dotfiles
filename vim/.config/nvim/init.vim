  ...
  require'nvim-treesitter.configs'.setup {
    ...
    highlight = {
      ...
      disable = function(lang, bufnr)
        return lang == "rust" or vim.api.nvim_buf_line_count(bufnr) > 5000
      end,
    ...
    --parser_config.dart.install_info.url =  "~/git/personal/tree-sitter-dart"

  require('gitsigns').setup {
    signs = {
      add = { hl = "diffAdded", text = "▊", numhl = "GitSignsAddNr", linehl = "GitSignsAddLn" },
      change = { hl = "diffFileId", text = "▊", numhl = "GitSignsChangeNr", linehl = "GitSignsChangeLn" },
